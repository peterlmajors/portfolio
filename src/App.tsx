      ...
      <main className="main">
        <section className="intro-flex">
          ...
          <p>
            ...
            founded and led the Sports Analytics Society for three years. The group's research sparked his interest in software and data science. See below for
            some of his work.
          </p>
        </section>
        <section>
        ...
        <section>
          ...
          <ul>
            ...
            <li>
              ...
              <ul>
                <li>Developed classification model for all 2022 Men's March Madness matchups </li>
              </ul>
            </li>
            <li>
